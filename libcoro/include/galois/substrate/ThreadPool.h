...
template <typename tpl, int s, int r> struct ExecuteTupleImpl {
...
template <typename tpl, int s> struct ExecuteTupleImpl<tpl, s, 0> {
...
public:
  ...
  template <typename... Args> void run(unsigned num, Args &&...args) {
    struct ExecuteTuple {
