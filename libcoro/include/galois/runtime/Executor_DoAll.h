        ...
        class DoAllStealingExec {
           ...
           constexpr static const bool USE_TERM = false;
            ...
            struct ThreadContext {
                ...
                ThreadContext() : work_mutex(), id(substrate::getThreadPool().getMaxThreads()),
                          shared_beg(), shared_end(), m_size(0) {
                }
            ...
            private:
                ...
                void steal_from_end_impl(Iter& steal_beg, Iter& steal_end, const Diff_ty sz, std::forward_iterator_tag) {
                ...
                void steal_from_end_impl(Iter& steal_beg, Iter& steal_end, const Diff_ty sz, std::bidirectional_iterator_tag) {
            ...
            static void call(const R& range, F func, const ArgsT& argsTuple) {
                ...
                runtime::on_each_gen(
                        [&](const unsigned int, const unsigned int) {
                            ...
                            static constexpr bool MORE_STATS = NEED_STATS && has_trait<more_stats_tag, ArgsT>();
